% https://github.com/ProbShin/Erdos_Renyi_Graph_Generator/blob/master/Erdos_Renyi_Graph.m
% Copyright (c) 2016, Xin Cheng
% All rights reserved.

function [G,n,m] = create_ERG_Graph(n,p,seed,format,opt)
%% 
%    Description:
